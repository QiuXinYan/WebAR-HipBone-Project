...
function SidebarObject(editor) {
	...
	*/
	...
	// //是否为被配准物体
	// const isRegistrationObjectRow = new UIRow();
	// const RegistrationObjectChecked = new UICheckbox().onChange(update);

	// isRegistrationObjectRow.add(new UIText("是否为被配准物体").setWidth('120px'));
	// isRegistrationObjectRow.add(RegistrationObjectChecked);

	// container.add(isRegistrationObjectRow);
	// name
	...
	function update() {
		...
		// if(RegistrationObjectChecked.getValue()) {
		// 	editor.uniqueObject = editor.selected;
		// }
		if (object !== null) {
